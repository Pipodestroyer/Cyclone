    ...
    run: async (message, args, Client) => {
        ...
        try{
            ...
            const denyEmbed = new MessageEmbed()
             ...
             .setColor("#44ff00")
             .addField(`Sugerencia aceptada: (por ${message.author.tag})`, `> ${maybesuggest}`)
             .setFooter("La sugerencia ha sido aceptada!")
             .setTimestamp()
            suggestedEmbed.edit(denyEmbed).then(m => {
