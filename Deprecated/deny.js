    ...
    run: async (message, args, Client) => {
        ...
        try{
            ...
            const denyEmbed = new MessageEmbed()
             ...
             .setColor("#ff0000")
             .addField(`Sugerencia denegada: (por ${message.author.tag})`, `> ${maybesuggest}`)
             .setFooter("La sugerencia ha sido denegada!")
             .setTimestamp()
